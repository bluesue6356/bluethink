...
var _class = function (_think$model$base) {
  ...
  _class.prototype.getRelation = function () {
              ...
              promises = (0, _keys2.default)(this.relation).map(function (key) {
                ...
                ['where', 'field', 'order', 'limit', 'page'].forEach(function (optItem) {
                  if (think.isFunction(item[optItem])) {
                    modelOpts[optItem] = item[optItem].call(_this2);
                  } else {
    ...
    return function getRelation(_x3, _x4) {
  ...
  _class.prototype._getHasOneRelation = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(data, mapOpts /*, options*/) {
      var where, mapData;
    ...
    return function _getHasOneRelation(_x6, _x7) {
      return ref.apply(this, arguments);
    };
  }();
  /**
  ...
  _class.prototype._getBelongsToRelation = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(data, mapOpts /*, options*/) {
      var where, mapData;
    ...
    return function _getBelongsToRelation(_x8, _x9) {
      return ref.apply(this, arguments);
    };
  }();
  /**
  ...
  _class.prototype._getHasManyRelation = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(data, mapOpts /*, options*/) {
      var where, mapData;
    ...
    return function _getHasManyRelation(_x10, _x11) {
      return ref.apply(this, arguments);
    };
  }();
  /**
  ...
  _class.prototype._getManyToManyRelation = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(data, mapOpts, options) {
    ...
    return function _getManyToManyRelation(_x12, _x13, _x14) {
      return ref.apply(this, arguments);
    };
  }();
  /**
  ...
  _class.prototype.parseRelationWhere = function parseRelationWhere(data, mapOpts) {
    ...
    return _ref2 = {}, _ref2[mapOpts.fKey] = data[mapOpts.key], _ref2;
  };
  /**
   * parse relation data
   * @param  {Object}  data     []
  ...
  _class.prototype.afterDelete = function afterDelete(data, options) {
  ...
  _class.prototype.postRelation = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6(postType, data /*, parsedOptions*/) {
      var _this3 = this;
    ...
    return function postRelation(_x15, _x16) {
      return ref.apply(this, arguments);
    };
  }();
  /**
  ...
  _class.prototype._postManyToManyRelation = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(data, mapOpts) {
          ...
          switch (_context7.prev = _context7.next) {
            ...
            case 10:
              ...
              postData = mapData.map(function (item) {
                ...
                return _ref3 = {}, _ref3[mapOpts.fKey] = data[mapOpts.key], _ref3[rfKey] = item[rfKey] || item, _ref3;
              });
              _context7.next = 18;
            ...
            case 27:
              ...
              postData = ids.map(function (id) {
                ...
                return _ref4 = {}, _ref4[mapOpts.fKey] = data[mapOpts.key], _ref4[rfKey] = id, _ref4;
              });
              _context7.next = 31;
              return relationModel.addMany(postData);
    ...
    return function _postManyToManyRelation(_x17, _x18) {
      return ref.apply(this, arguments);
    };
  }();
  /**
  ...
  _class.prototype._getRalationAddIds = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8(dataList, model, unqiueField) {
      var ids, pk, promises;
    ...
    return function _getRalationAddIds(_x19, _x20, _x21) {
      return ref.apply(this, arguments);
    };
  }();
