...
var _class = function (_think$http$base) {
  ...
  _class.prototype.display = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(templateFile, charset, contentType, config) {
      var content;
    ...
    return function display(_x, _x2, _x3, _x4) {
  ...
  _class.prototype.fetch = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(templateFile, data, config) {
    ...
    return function fetch(_x8, _x9, _x10) {
      return ref.apply(this, arguments);
    };
  }();
