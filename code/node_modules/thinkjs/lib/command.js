...
var getProjectAppPath = function getProjectAppPath() {
  ...
  path += _commander2.default.es || _commander2.default.ts ? 'src' : 'app';
  return path;
};
/**
 * get app name
...
var copyFile = function copyFile(source, target, replace, showWarning) {
  ...
  var es = _commander2.default.es || _commander2.default.es6;
...
var parseAppConfig = function parseAppConfig() {
  ...
  _commander2.default.es = data.es || data.es6; //compatible with 2.0.x
...
_commander2.default.option('-e, --es', 'use es for project, used in `new` command');
_commander2.default.option('--es6', 'use es for project, used in `new` command');
...
_commander2.default.command('new <projectPath>').description('create project').action(function (projectPath) {
  ...
  _commander2.default.es = _commander2.default.es || _commander2.default.es6;
  createProject();
});
